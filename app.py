...
html = dedent(
    ...
    *{box-sizing:border-box}html,body{margin:0;background:var(--bg);color:var(--text);font-family:"Microsoft YaHei UI","PingFang SC",sans-serif;overflow:hidden}
    ...
    .line{position:absolute;height:1px;transform-origin:left center;background:linear-gradient(90deg,#24cde988,#24cde915);z-index:0;overflow:visible}.line:after,.line:before{content:"";position:absolute;left:0;top:-4px;width:8px;height:8px;border:2px solid #fff;border-radius:50%;background:#00a779;box-shadow:0 0 9px #00a779;animation:packet 2.4s linear infinite}.line:before{animation-delay:-1.2s}@keyframes packet{from{left:0;opacity:.12}15%{opacity:1}85%{opacity:1}to{left:calc(100% - 8px);opacity:.12}}.line.hot{height:2px;background:linear-gradient(90deg,#b5f6ff,#23cde7);box-shadow:0 0 7px #28d9f0;animation:glow 1.3s ease-in-out infinite alternate}.line.hot:after,.line.hot:before{animation-duration:1.35s}.line.hot:before{animation-delay:-.675s}@keyframes glow{from{opacity:.45}to{opacity:1}}.line.branchLine{opacity:.48}.line.offlineLine{height:1px;background:repeating-linear-gradient(90deg,#aab9b5 0 5px,transparent 5px 10px);box-shadow:none;opacity:.48}.line.offlineLine:after,.line.offlineLine:before{display:none}
