    ...
    *{box-sizing:border-box}html,body{margin:0;background:var(--bg);color:var(--text);font-family:"Microsoft YaHei UI","PingFang SC",sans-serif;overflow:hidden}
    ...
    function renderMap(){
      ...
      if(focused&&cityPoints[active]){
        ...
        parts.push(`<g class="mapFocusCityLabel"><rect x="220" y="50" width="176" height="48" rx="10"/><text class="caption" x="234" y="68">当前地市智能体</text><text class="name" x="234" y="88">${escapeHtml(c.name)}</text></g>`);
